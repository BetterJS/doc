...
``` javascript 
   ...
   // 启动
   docker run -i -d -p 80:80 -p 8081:8081 docker.io/caihuijigood/badjs-docker:lastest bash badjs mysql=mysql://root:root@192.168.1.101:3306/badjs mongodb=mongodb://192.168.1.101:27017/badjs
```
